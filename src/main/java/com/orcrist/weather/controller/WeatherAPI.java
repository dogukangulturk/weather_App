...
@Validated
@Tag(name = "Open Weather Service API v1",
...
public class WeatherAPI {
    ...
    @Operation(
            ...
            description = "search the current weather report of the city name filter. " +
                    "The api has the rate limiting. 10 request per minute",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
